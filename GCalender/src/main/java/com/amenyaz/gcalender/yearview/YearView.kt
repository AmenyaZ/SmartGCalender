//package com.amenyaz.gcalender.yearview
//
...
//import com.amenyaz.gcalender.R
...
//        mHeaderTextPaint!!.textSize =
//            resources.getDimensionPixelSize(R.dimen.smalltextsize).toFloat()
//        mdayrect = Rect()
...
//                mHeaderTextPaint!!.getTextBounds(
//                    monthname,
//                    0,
//                    monthname.length,
//                    mHeaderTextPaintRect
//                )
//                val eachcellsize = (eachmonthwidth - 30) / 7.0f
//                //30 because of margin left each month
//                canvas.drawText(
//                    monthname,
//                    30 + eachmonthwidth * n + eachcellsize / 2.0f - mdayrect!!.width() / 2.0f,
//                    30 + eachmonthheight * m + mHeaderTextPaintRect!!.height(),
//                    mHeaderTextPaint!!
//                )
//                //20 is topwidth
//                for (i in 0..6) {
//                    canvas.drawText(
//                        dayname[i],
//                        30 + eachmonthwidth * n + eachcellsize * i + eachcellsize / 2.0f - mdayrect!!.width() / 2.0f,
//                        30 + eachmonthheight * m + mHeaderTextPaintRect!!.height() + mdayrect!!.height() + 20,
//                        daypaint!!
//                    )
//                }
//                //   20 is datestartheight
//                val endofdayheight =
//                    30 + eachmonthheight * m + mHeaderTextPaintRect!!.height() + mdayrect!!.height() + 20 + 20
...
//                            canvas.drawCircle(
//                                30 + eachmonthwidth * n + eachcellsize * j + eachcellsize / 2.0f,
//                                endofdayheight + eachcellheight * i + eachcellheight / 2.0f,
//                                eachcellsize / 2.0f,
//                                roundpaint!!
//                            )
//                            canvas.drawText(
//                                text,
//                                30 + eachmonthwidth * n + eachcellsize * j + eachcellsize / 2.0f - mdaterect!!.width() / 2.0f,
//                                endofdayheight + eachcellheight * i + eachcellheight / 2.0f + mdaterect!!.height() / 2.0f,
//                                todaypaint!!
//                            )
//                        } else {
//                            canvas.drawText(
